...
import { ClientInfo, MasterInfo } from '@/entities/Visit/model/types/visit';
import { getVisitForm } from '@/entities/Visit/model/selectors/getVisitForm';
import { updateVisit } from '@/entities/Visit/model/services/updateVisit';
import { addVisit } from '@/entities/Visit/model/services/addVisit';
...
const Form = memo(({ className, onSuccess, title, actionName }: FormProps) => {
